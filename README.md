...
Начинающий фронтенд-разработчик, увлечен веб-разработкой и стремлюсь развивать свои навыки.
В настоящее время совмещаю обучение в ВУЗе с прохождением курса по фронтенд-разработке от Хекслет.
Успел реализовать 2 проекта по курсу фронтенд-разработка от Хекслет: [brain-games](https://github.com/shruge/brain-games), [gendiff](https://github.com/shruge/gendiff)
...
<!--
**shruge/shruge** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
